    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide text-gray-300">LABORATORY FUME EXTRACTION SYSTEMS</span>
        </motion.div>
        ...
        >
          <span className="text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-500">ARIAS</span>
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 text-glow">Fume Hoods</span>
        </motion.h1>
